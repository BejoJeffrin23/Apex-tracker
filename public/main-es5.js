...
var HttpServiceService = /** @class */ (function () {
    ...
    HttpServiceService.prototype.getsingle = function (device, tag) {
        var one = this._http.get(this.baseUrl + "/" + device + "/" + tag);
        console.log(one);
        return one;
    };
...
var TrackComponent = /** @class */ (function () {
    function TrackComponent(httpService, router, spinner) {
        var _this = this;
        ...
        this.get = function () {
            ...
            console.log(_this.device, _this.gamerTag);
            _this.httpService.getsingle(_this.device, _this.gamerTag).subscribe(function (data) {
                _this.httpService.setUserInfoInLocalStorage(data);
                console.log(data);
    ...
    TrackComponent.ctorParameters = function () { return [
...
var ViewDetailComponent = /** @class */ (function () {
    function ViewDetailComponent(httpService) {
        this.httpService = httpService;
    }
